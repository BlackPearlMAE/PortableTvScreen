Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/7496c12254f22e0498dc169f1d7d0189"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalOverrideAlpha = (2.0 /*_DecalOverrideAlpha*/);
				...
				{
					udonVideoAspectRatio = Decal0.GetVideoAspectRatio(_Udon_VideoTex_TexelSize.zw, (0.0 /*_Decal0VideoAspectFix*/), (0.0 /*_Decal0VideoFitToScale*/));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				clip(poiFragData.alpha - (0.169 /*_Cutoff*/));
